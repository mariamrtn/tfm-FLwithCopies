...
from pytorchexample_changesXI.task import BinaryClassifier, SmallNN
from pytorchexample_changesXI.custom_strategy import custom_strategy #importar la nueva estrategia
